...
def threeNorth():
    ...
    if choice == "fight":
        if inv(0, "list", 0, 0, 0)[0] == "sword":
            roll = dice(5)
            print(
                "You decide to stay and fight. Good thing you bought that sword, because you only need more than 5 on the dice to win. You rolled: " + roll[0])
            if roll[1] == True:
                print("You won! -15HP")
                hp(0, "edit", -15)
                threeIce()
        ...
        if inv(0, "list", 0, 0, 0)[0] == "branch":
            roll = dice(15)
            print(
                "You decide to stay and fight. You only have a branch and your bow. You need more than 15 on the dice to win. You rolled: " + roll[0])
            if roll[1] == True:
